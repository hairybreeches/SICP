...
(deftest test-flip-horiz-backslash
  (is (= (first (get-lines-drawn (flip-horiz backslash-painter) whole-canvas)) (line-to-string [0.0 0.0] [1.0 1.0]))))

(deftest test-flip-horiz-forwardslash
  (is (= (first (get-lines-drawn (flip-horiz forwardslash-painter) whole-canvas)) (line-to-string [1.0 0.0] [0.0 1.0]))))
